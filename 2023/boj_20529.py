...
for tc in range(int(input())):
    ...
    # 무조건 세 사람을 봐야할 때
        ...
        print(answer)
'''
a = ['ISTJ', 'ISFJ', 'INFJ', 'INTJ', 'ISTP', 'ISFP', 'INFP', 'INTP']
b = dict.fromkeys(a, 0)
print(b)  # {'ISTJ': 0, 'ISFJ': 0, 'INFJ': 0, 'INTJ': 0, 'ISTP': 0, 'ISFP': 0, 'INFP': 0, 'INTP': 0}

print(dict.setdefault(b, 'CUTE', 0))  # 0
print(b)  # {'ISTJ': 0, 'ISFJ': 0, ... , 'INFP': 0, 'CUTE': 0}
'''